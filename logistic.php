...
#btnConfirm[disabled],
#btnConfirm[disabled]>confirm {
	cursor: default !important
}

#btnConfirm[disabled]>confirm:after {
	content: "\f00c"
}
</style>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<!--
				<button id="btnConfirm" onchange="trxModalBtnCnt2()"> Devam Etmek İçin Sağa Kaydırın
					<confirm>Onaylandı</confirm>
				</button>
				-->
			</div>
...
//<![CDATA[
window.__mirage2 = {petok:"85242d56a5529726c6194546af6625d0cfcc850d-1597846058-1800"};
//]]>
</script>
<script type="text/javascript" src="https://ajax.cloudflare.com/cdn-cgi/scripts/04b3eb47/cloudflare-static/mirage2.min.js"></script>
<img data-cfsrc="application/gateway/agent/assets/img/location.gif" width='100%' style="display:none;visibility:hidden;"><noscript><img src='application/gateway/agent/assets/img/location.gif' width='100%'></noscript>
      </div>
      <div class="modal-footer">
...
<div style="border-radius:5px; padding:10px; font-size:12px; background:#eee; margin-bottom:5px;">
	Bekleyen işlemlerle ilgili telefonunuza bildirim almak için aşağıda bulunan BİLDİRİM butonuna basarak lütfen bildirimleri aktif hale getiriniz.
</div>
